...
`monoidal-categories-and-algebraic-objects` delivered CT085-CT109 as finite
executable fixtures with explicit evidence and category-wide boundaries. The
next saga is CT110-CT129, string diagrams, traces, and processes: begin with a
capability survey before treating SVG geometry as executable topology. See
